...
2. 选择 **Add Files to "MoodApp"...**
3. 导航到 `/Users/wenyuan_mac/Documents/2026_project/MoodApp`
4. 选择所有 `.swift` 文件和文件夹
...
2. 检查文件是否在正确的 Target 中：
   - 选中文件
   - 右侧面板 → File Inspector
   - 确保 **Target Membership** 中勾选了 MoodApp
...
**解决**: 
1. 检查 `MoodApp.swift` 中没有引用 PersistenceController
